...
namespace Animation1
{
    public partial class FrmAnimation : Form
    {
        ...
        //Images used in game - flame image added
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            //if flame reaches right side without hitting target
            //move it off screen
            ...
            //Check for hit (either with flame or direct baby collision)
        ...
        private void Initialize()
        {
            ...
            //don't move flame until correct key is pressed
            dxflame = 0;
