...
namespace Blackboard
{
    partial class Form1 : Form
    {
        ...
        {
            if (CboBackground.Text=="Gray")
            {
                pnlBlackboard.BackColor = Color.Gray;
            }
            else if (CboBackground.Text == "Blue")
            {
                pnlBlackboard.BackColor = Color.Blue;
            }
            else if (CboBackground.Text == "Green")
            {
                pnlBlackboard.BackColor = Color.Green;
            }
            else if (CboBackground.Text=="Cyan")
            {
                pnlBlackboard.BackColor = Color.Gray;
            }
            else if (CboBackground.Text == "Red")
            {
                pnlBlackboard.BackColor = Color.Red;
            }
            else if (CboBackground.Text == "Magenta")
            {
                pnlBlackboard.BackColor = Color.Magenta;
            }
            else if (CboBackground.Text == "Yellow")
            {
                pnlBlackboard.BackColor = Color.Gray;
            }
            else if (CboBackground.Text == "White")
            {
                pnlBlackboard.BackColor = Color.Gray;
            }                
